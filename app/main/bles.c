...
#define DEVICE_NAME                     "Pumelo-ESL"                           /**< Name of device. Will be included in the advertising data. */
#define MANUFACTURER_NAME               "PumeloTech"                       /**< Manufacturer. Will be passed to Device Information Service. */
...
static ble_esls_t m_esls;                                                            /**< Structure used to identify the DFU service. */
...
static void service_esls_init()
{
    uint32_t err_code;
    ble_esls_init_t esls_init;
...
static void ble_evt_dispatch(ble_evt_t * p_ble_evt)
{
    ...
    ble_esls_on_ble_evt(&m_esls, p_ble_evt);
